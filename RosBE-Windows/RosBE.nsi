...
;;
VIAddVersionKey /LANG=1033 "FileVersion" "2.1.1.0"
...
VIAddVersionKey /LANG=1033 "LegalTrademarks" "Copyright © 2013 ReactOS Foundation"
VIAddVersionKey /LANG=1033 "LegalCopyright" "Copyright © 2013 ReactOS Foundation"
    ...
    IfFileExists "$SMPROGRAMS\$ICONS_GROUP\ReactOS Build Environment.lnk" +13 0
        !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
            ...
            IfFileExists "$INSTDIR\RosBE.ps1" 0 +2
                CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\ReactOS Build Environment - PS.lnk" "$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" "-noexit &'$INSTDIR\RosBE.ps1'" "$INSTDIR\rosbe.ico"
            SetOutPath $INSTDIR
...
Function un.onInit
    ...
    IDNO +5
        ...
        Delete /REBOOTOK "$DESKTOP\ReactOS Build Environment - PS.lnk"
        Delete /REBOOTOK "$QUICKLAUNCH\ReactOS Build Environment - PS.lnk"
FunctionEnd
